...
public class Customermaster {
    ...
    private Date latelytradeturndate;
    ...
    public Date getLatelytradeturndate() {
        return latelytradeturndate;
    }

    public void setLatelytradeturndate(Date latelytradeturndate) {
        this.latelytradeturndate = latelytradeturndate;
    }
    ...
    public String getTransnewid() {
        return transnewid;
    }

    public void setTransnewid(String transnewid) {
        this.transnewid = transnewid;
    }
    ...
    public String getYadvrecv() {
        return yadvrecv;
    }

    public void setYadvrecv(String yadvrecv) {
        this.yadvrecv = yadvrecv;
    }
